  ...
  const headerTitle = useMemo(() => {
    ...
    if (section === 'email') {
      if (matchingAccount?.email || matchingAccount?.verifiedEmail) {
        ...
        return `No email address found. Ask your Twinkle teacher for help. If you no longer attend Twinkle, send an email to mikey at mikey1384@gmail.com for help`;
      }
    }
    return 'TBD';
  }, [matchingAccount, section]);
